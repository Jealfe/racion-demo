if(typeof document!=='undefined'&&!window.__familyGamesV1){
  ...
  #games{padding-bottom:110px}.game-shell{display:grid;gap:12px}.game-hero{padding:18px;border-radius:24px;background:linear-gradient(145deg,#fff,#f3efff);border:1px solid #ece5f5;box-shadow:0 8px 25px rgba(63,45,74,.05)}
  ...
  .game-draw-turn{position:relative;overflow:visible;padding:14px;background:#fff}.game-draw-inner{width:100%;margin:0 auto}.game-draw-header{display:grid;grid-template-columns:42px 1fr;gap:10px;align-items:start;margin-bottom:4px}.game-draw-back{width:40px;height:40px;border:0;border-radius:13px;background:#f3efeb;font-size:22px;font-weight:800;cursor:pointer}.game-draw-part{font-size:23px!important;line-height:1.05;margin:2px 0 5px!important}.game-draw-hint{font-size:10px!important;color:#8d8380!important;line-height:1.4!important}.game-draw-stage{width:min(100%,560px);margin:8px auto 0}.game-draw-bottom{width:min(100%,560px);margin:0 auto}.game-draw-turn .game-progress{margin:7px 0 8px}.game-draw-turn .game-primary{position:static;box-shadow:none}
  @media(max-width:520px){.game-draw-turn{padding:12px 10px}.game-draw-turn .game-canvas{width:100%;max-height:none}.game-draw-part{font-size:21px!important}.game-draw-turn .game-tools{position:static;background:transparent;padding:8px 0 5px}}
